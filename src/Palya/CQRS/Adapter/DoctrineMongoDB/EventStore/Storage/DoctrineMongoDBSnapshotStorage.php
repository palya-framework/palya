...
/**
 * The storage for an snapshot store based on the Doctrine MongoDB
 * implementation.
 *
...
class DoctrineMongoDBSnapshotStorage extends AbstractDoctrineMongoDBStorage implements SnapshotStorageInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    public function saveSnapshot(EventProviderInterface $eventProvider)
    {
        ...
        $data = [
            'data' => $this->serializer->serialize($eventProvider, 'json'),
